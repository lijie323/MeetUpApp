...
class MeetupsControllerTest < ActionController::TestCase
  ...
  test "should create meetup" do
    assert_difference('Meetup.count') do
      post :create, meetup: { discription: @meetup.discription, groupid: @meetup.groupid, location: @meetup.location, time: @meetup.time, title: @meetup.title }
    end
  ...
  test "should update meetup" do
    put :update, id: @meetup, meetup: { discription: @meetup.discription, groupid: @meetup.groupid, location: @meetup.location, time: @meetup.time, title: @meetup.title }
    assert_redirected_to meetup_path(assigns(:meetup))
  end
